<%@ page import="vovik.java.webapp.model.*" %>
...
<head>
    ...
    <jsp:useBean id="resume" type="vovik.java.webapp.model.Resume" scope="request"/>
...
<section>
    ...
    <p>
        <c:forEach var="type" items="${resume.contacts.keySet()}">
            <jsp:useBean id="type" type="vovik.java.webapp.model.ContactType"/>
        ...
        %>
            ...
            <c:forEach var="org" items="<%=((OrganizationSection) entry.getValue()).getValues()%>">
                ...
                <c:forEach var="period" items="${org.periods}">
                    <jsp:useBean id="period" type="vovik.java.webapp.model.Organization.Period"/>
                    <tr>
