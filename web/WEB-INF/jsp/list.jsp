<%@ page import="vovik.java.webapp.WebAppConfig" %>
<%@ page import="vovik.java.webapp.model.ContactType" %>
<%@ page import="vovik.java.webapp.model.Resume" %>
<%@ page import="vovik.java.webapp.web.HtmlUtil" %>
<%@ page import="java.util.Collection" %>
<%@ page import="vovik.java.webapp.storage.XmlFileStorage" %>
            ...
            <td>
                <table border="1" cellpadding="8" cellspacing="0">
                    ...
                    <c:forEach items="${resumeList}" var="resume">
                        <jsp:useBean id="resume" type="vovik.java.webapp.model.Resume"/>
                        <tr>
